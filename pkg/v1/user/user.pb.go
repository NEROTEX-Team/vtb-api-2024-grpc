...
func (x *FetchUserListRequest) Reset() {
	*x = FetchUserListRequest{}
	mi := &file_api_v1_user_user_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FetchUserListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchUserListRequest) ProtoMessage() {}

func (x *FetchUserListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_user_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchUserListRequest.ProtoReflect.Descriptor instead.
func (*FetchUserListRequest) Descriptor() ([]byte, []int) {
	return file_api_v1_user_user_proto_rawDescGZIP(), []int{5}
}

func (x *FetchUserListRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *FetchUserListRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type FetchUserListResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FetchUserListResponse) Reset() {
	*x = FetchUserListResponse{}
	mi := &file_api_v1_user_user_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FetchUserListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetchUserListResponse) ProtoMessage() {}

func (x *FetchUserListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_user_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetchUserListResponse.ProtoReflect.Descriptor instead.
func (*FetchUserListResponse) Descriptor() ([]byte, []int) {
	return file_api_v1_user_user_proto_rawDescGZIP(), []int{6}
}

func (x *FetchUserListResponse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *FetchUserListResponse) GetUsers() []*User {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_api_v1_user_user_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x6c, 0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x39, 0x0a, 0x0a, 0x63, 0x72,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x37, 0x0a, 0x15, 0x46, 0x65, 0x74, 0x63,
	0x68, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x72, 0x22, 0x65, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x6c, 0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x34, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61,
	...
	0x0a, 0x14, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52,
	...
	0x66, 0x73, 0x65, 0x74, 0x22, 0x4f, 0x0a, 0x15, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65,
	...
	0x74, 0x61, 0x6c, 0x12, 0x20, 0x0a, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05,
	0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x34, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x2f, 0x0a, 0x17, 0x46,
	0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x3a, 0x0a, 0x18,
	...
	0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x27, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69,
	0x64, 0x22, 0x75, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	,
	...
	0x65, 0x12, 0x36, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12,
	0x1b, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65,
	0x72, 0x42, 0x79, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0b, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x3f, 0x0a, 0x0a, 0x43, 0x72, 0x65,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x51, 0x0a, 0x10, 0x46, 0x65,
	0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1d,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x42,
	0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x46, 0x65, 0x74, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79,
	0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x15, 0x5a,
	0x13, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x3b, 0x75,
	0x73, 0x65, 0x72, 0x3b, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_v1_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_v1_user_user_proto_goTypes = []any{
	...
	(*FetchUserListRequest)(nil),     // 5: user.FetchUserListRequest
	(*FetchUserListResponse)(nil),    // 6: user.FetchUserListResponse
	(*UpdateUserResponse)(nil),       // 7: user.UpdateUserResponse
	(*FetchUserByEmailRequest)(nil),  // 8: user.FetchUserByEmailRequest
	(*FetchUserByEmailResponse)(nil), // 9: user.FetchUserByEmailResponse
...
var file_api_v1_user_user_proto_depIdxs = []int32{
	...
	0,  // 2: user.FetchUserByIdResponse.user:type_name -> user.User
	0,  // 3: user.CreateUserResponse.user:type_name -> user.User
	0,  // 4: user.FetchUserListResponse.users:type_name -> user.User
	0,  // 5: user.UpdateUserResponse.user:type_name -> user.User
	0,  // 6: user.FetchUserByEmailResponse.user:type_name -> user.User
	1,  // 7: user.UserV1.FetchUserById:input_type -> user.FetchUserByIdRequest
	5,  // 8: user.UserV1.FetchUserList:input_type -> user.FetchUserListRequest
	11, // 9: user.UserV1.UpdateUser:input_type -> user.UpdateUserRequest
	10, // 10: user.UserV1.DeleteUser:input_type -> user.DeleteUserByIdRequest
	3,  // 11: user.UserV1.CreateUser:input_type -> user.CreateUserRequest
	8,  // 12: user.UserV1.FetchUserByEmail:input_type -> user.FetchUserByEmailRequest
	2,  // 13: user.UserV1.FetchUserById:output_type -> user.FetchUserByIdResponse
	6,  // 14: user.UserV1.FetchUserList:output_type -> user.FetchUserListResponse
	7,  // 15: user.UserV1.UpdateUser:output_type -> user.UpdateUserResponse
	12, // 16: user.UserV1.DeleteUser:output_type -> user.Empty
	4,  // 17: user.UserV1.CreateUser:output_type -> user.CreateUserResponse
	9,  // 18: user.UserV1.FetchUserByEmail:output_type -> user.FetchUserByEmailResponse
