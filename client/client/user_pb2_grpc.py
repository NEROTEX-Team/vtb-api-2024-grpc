...
class UserV1Stub(object):
    ...
    def __init__(self, channel):
        ...
        self.FetchListUsers = channel.unary_unary(
                ...
                request_serializer=user__pb2.FetchAllUsersRequest.SerializeToString,
...
def add_UserV1Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'FetchListUsers': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__pb2.FetchAllUsersRequest.FromString,
...
class UserV1(object):
    ...
    def FetchListUsers(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user.UserV1/FetchListUsers',
            user__pb2.FetchAllUsersRequest.SerializeToString,
